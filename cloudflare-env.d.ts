/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: dde27e5c841a69156ff51f2f8e446b3c)
// Runtime types generated with workerd@1.20251210.0 2026-01-02 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
	}
	interface Env {
		ENV_NAME: "production" | "preview";
		NEXT_PUBLIC_BASE_URL: "https://muuuuminn.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV_NAME" | "NEXT_PUBLIC_BASE_URL" | "NEXT_PUBLIC_GOOGLE_ANALYTICS_ID" | "NEXTJS_ENV">> {}
}
